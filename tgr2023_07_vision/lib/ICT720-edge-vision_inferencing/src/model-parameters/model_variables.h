...
const char* ei_classifier_inferencing_categories[] = { "OBJ_01" };
...
const ei_impulse_t impulse_649994_0 = {
    .project_id = 649994,
    .project_owner = "Supachai Vorapojpisut",
    .project_name = "ICT720-edge-vision",
    .impulse_id = 1,
    ...
    .visual_ad_grid_size_x = int((240 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((240 / 8) / 2 - 1),
    
    .tflite_output_features_count = 1800,
...
ei_impulse_handle_t impulse_handle_649994_0 = ei_impulse_handle_t( &impulse_649994_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_649994_0;
